...
nfn_fwd3 = NFNForwarder(port=0, encoder=NdnTlvEncoder(),
                        ...
                        ageing_interval=1)
nfn_fwd3.executors["PYTHONSTREAM"].initialize_executor(nfn_fwd3.nfnlayer.queue_to_lower, nfn_fwd3.nfnlayer.queue_from_lower, nfn_fwd3.nfnlayer.computation_table, nfn_fwd3.nfnlayer.cs, nfn_fwd3.icnlayer.pit)
...
nfn_fwd4 = NFNForwarder(port=0, encoder=NdnTlvEncoder(),
                        ...
                        ageing_interval=1)
nfn_fwd4.executors["PYTHONSTREAM"].initialize_executor(nfn_fwd4.nfnlayer.queue_to_lower, nfn_fwd4.nfnlayer.queue_from_lower, nfn_fwd4.nfnlayer.computation_table, nfn_fwd4.nfnlayer.cs, nfn_fwd4.icnlayer.pit)
...
nfn_fwd5 = NFNForwarder(port=0, encoder=NdnTlvEncoder(),
                        ...
                        ageing_interval=1)
nfn_fwd5.executors["PYTHONSTREAM"].initialize_executor(nfn_fwd5.nfnlayer.queue_to_lower, nfn_fwd5.nfnlayer.queue_from_lower, nfn_fwd5.nfnlayer.computation_table, nfn_fwd5.nfnlayer.cs, nfn_fwd5.icnlayer.pit)
