...
class EdgeComputingSimpleSimulation1(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.fetch_tool4 = Fetch("rsu4", None, 255, self.encoder_type(), interfaces=[self.simulation_bus.add_interface("fetchtool4")])
        ...
        self.rsu4 = NFNForwarder(port=0, encoder=self.encoder_type(),
                                 interfaces=[self.simulation_bus.add_interface("rsu4")], log_level=255,
                                 ageing_interval=1)
        ...
        self.rsu4.icnlayer.pit.set_pit_timeout(0)
        self.rsu4.icnlayer.cs.set_cs_timeout(30)
        ...
        self.rsu4.nfnlayer.optimizer = EdgeComputingOptimizer(self.rsu4.icnlayer.cs, self.rsu4.icnlayer.fib, self.rsu4.icnlayer.pit, self.rsu4.linklayer.faceidtable)
    ...
    def setup_faces_and_connections(self):
        ...
        self.mgmt_client3.add_face("rsu4", None, 0)
        self.mgmt_client3.add_forwarding_rule(Name("/rsu"), [0,1])
        self.mgmt_client3.add_new_content(Name("/rsu/func/f1"), "PYTHON\nf\ndef f(a):\n    for i in range(0,30000000):\n        a.upper()\n    return a.upper() + ' RSU3'")

        #setup rsu4
        self.mgmt_client4.add_face("rsu4", None, 0)
        self.mgmt_client4.add_forwarding_rule(Name("/rsu"), [0])
        self.mgmt_client4.add_new_content(Name("/rsu/func/f1"), "PYTHON\nf\ndef f(a):\n    for i in range(0,40000000):\n        a.upper()\n    return a.upper() + ' RSU4'")
