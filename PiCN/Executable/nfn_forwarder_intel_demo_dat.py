...
def main(argv):
    ...
    forwarder = PiCN.ProgramLibs.NFNForwarder.NFNForwarder(9100, log_level, encoder)
    forwarder.start_forwarder()

    time.sleep(1)

    add_info1 = AddressInfo(("127.0.0.1", 9200), 0)
    fid1 = forwarder.linklayer.faceidtable.get_or_create_faceid(add_info1)
    forwarder.icnlayer.fib.add_fib_entry(Name("/ndn/ch/unibas/nfn/fct"), [fid1], True)
