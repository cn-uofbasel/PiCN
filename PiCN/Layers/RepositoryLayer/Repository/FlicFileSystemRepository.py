# PiCN/Layers/RepositoryLayer/Repository/FlicFileSystemRepository.py

'''
A file-system based repo
that generates and serves FLICed content (aka "manifests")
...
class FlicFileSystemRepository(BaseRepository):
