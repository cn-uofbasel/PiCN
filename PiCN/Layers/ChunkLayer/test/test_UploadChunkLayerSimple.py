...
class test_UploadChunkLayerSimple(unittest.TestCase):
    """Testing the Basic Chunk Layer"""
    ...
    def setUp(self):
        ...
        self.chunkLayer: DataOffloadingChunklayerSimple = DataOffloadingChunklayerSimple(cs, pit, fib)
    ...
    def test_handle_received_meta_data(self):
        ...
        self.chunkLayer.handle_received_meta_data(0, md1, request_table_entry, self.q1_to_lower, False)
        ...
        self.assertEqual(Name("/test/data/m1"), d1.name)
        self.assertTrue(self.q1_to_lower.empty())

        self.chunkLayer.handle_received_meta_data(0, md2, request_table_entry, self.q1_to_lower, False)
    ...
    def test_handle_received_chunk_data(self):
        ...
        self.chunkLayer.handle_received_chunk_data(0, chunk1, request_table_entry, self.q1_to_higher)
        request_table_entry = self.chunkLayer.get_request_entry(n1)
        self.assertEqual(request_table_entry.requested_chunks, [chunk2_n])

        self.chunkLayer.handle_received_chunk_data(0, chunk2, request_table_entry, self.q1_to_higher)
        request_table_entry = self.chunkLayer.get_request_entry(n1)
        self.assertEqual(len(request_table_entry.requested_md), 0)
    ...
    def test_metadata_from_lower_layer(self):
        ...
        self.assertEqual(Interest(md2_n), data)
    ...
    def test_cl_interest_sent(self):
        """Test if cl message is generated and sent"""
        self.chunkLayer.start_process()
        interest = Interest("/car/test/data")
        cl_interest_name = Name("/nL/car/test/data/CL1")
