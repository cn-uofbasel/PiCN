...
config_PiCN = {
    ...
    'packages': ['PiCN', 'PiCN.Processes', 'PiCN.Layers.LinkLayer', 'PiCN.Layers.PacketEncodingLayer',
                 ...
                 'PiCN.Layers.NFNLayer.NFNOptimizer', 'PiCN.Layers.NFNLayer.NFNExecutor', 'PiCN.Layers.TimeoutPreventionLayer',
                 'PiCN.Layers.ThunkLayer', 'PiCN.Layers.ThunkLayer.ThunkTable',
                 'PiCN.ProgramLibs.NFNForwarder', 'PiCN.Simulations'],
    'scripts': [],
    'test_suite': 'nose2.collector.collector',
    'tests_require': ['nose2', 'rednose', 'nose-progressive', 'numpy', 'matplotlib', 'cv2', 'requests', 'zipfile', 'tensorflow', 'pygeodesy'],
    'name': 'PiCN'
}
classifiers_PiCN=[
